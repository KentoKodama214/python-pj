...
def main():
    ...
    with futures.ThreadPoolExecutor() as executor:
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"PopTotal": "総人口", "LabourIncome": "労働所得"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "LabourIncome_vs_PopTotal_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"PopTotal": "総人口", "LabourIncome": "労働所得"}, countries = ["Brazil", "Mexico", "Canada"], filename = "LabourIncome_vs_PopTotal_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"PopTotal": "総人口", "Import": "輸入額"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "Import_vs_PopTotal_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"PopTotal": "総人口", "Import": "輸入額"}, countries = ["Brazil", "Mexico", "Canada"], filename = "Import_vs_PopTotal_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"LabourIncome": "労働所得", "Import": "輸入額"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "Import_vs_LabourIncome_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"LabourIncome": "労働所得", "Import": "輸入額"}, countries = ["Brazil", "Mexico", "Canada"], filename = "Import_vs_LabourIncome_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"PopTotal": "総人口", "Export": "輸出額"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "Export_vs_PopTotal_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"PopTotal": "総人口", "Export": "輸出額"}, countries = ["Brazil", "Mexico", "Canada"], filename = "Export_vs_PopTotal_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"LabourIncome": "労働所得", "Export": "輸出額"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "Export_vs_LabourIncome_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"LabourIncome": "労働所得", "Export": "輸出額"}, countries = ["Brazil", "Mexico", "Canada"], filename = "Export_vs_LabourIncome_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"Import": "輸入額", "Export": "輸出額"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "Export_vs_Import_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"Import": "輸入額", "Export": "輸出額"}, countries = ["Brazil", "Mexico", "Canada"], filename = "Export_vs_Import_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"PopTotal": "総人口", "NGDPD": "NGDPD"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "NGDPD_vs_PopTotal_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"PopTotal": "総人口", "NGDPD": "NGDPD"}, countries = ["Brazil", "Mexico", "Canada"], filename = "NGDPD_vs_PopTotal_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"LabourIncome": "労働所得", "NGDPD": "NGDPD"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "NGDPD_vs_LabourIncome_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"LabourIncome": "労働所得", "NGDPD": "NGDPD"}, countries = ["Brazil", "Mexico", "Canada"], filename = "NGDPD_vs_LabourIncome_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"Export": "輸出額", "NGDPD": "NGDPD"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "NGDPD_vs_Export_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"Export": "輸出額", "NGDPD": "NGDPD"}, countries = ["Brazil", "Mexico", "Canada"], filename = "NGDPD_vs_Export_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"PopTotal": "総人口", "PPPSH": "PPPSH"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "PPPSH_vs_PopTotal_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"PopTotal": "総人口", "PPPSH": "PPPSH"}, countries = ["Brazil", "Mexico", "Canada"], filename = "PPPSH_vs_PopTotal_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"LabourIncome": "労働所得", "PPPSH": "PPPSH"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "PPPSH_vs_LabourIncome_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"LabourIncome": "労働所得", "PPPSH": "PPPSH"}, countries = ["Brazil", "Mexico", "Canada"], filename = "PPPSH_vs_LabourIncome_North_and_South_America"))
        ...
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"Export": "輸出額", "PPPSH": "PPPSH"}, countries = ["Egypt", "Ethiopia", "Nigeria", "Niger"], filename = "PPPSH_vs_Export_Africa"))
        future_list.append(executor.submit(analysisData.plot_connected_scatter_countries, target_dict = {"Export": "輸出額", "PPPSH": "PPPSH"}, countries = ["Brazil", "Mexico", "Canada"], filename = "PPPSH_vs_Export_North_and_South_America"))
